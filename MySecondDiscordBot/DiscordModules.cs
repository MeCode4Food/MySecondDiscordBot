...
namespace MySecondDiscordBot
{
    public class DiscordModules : ModuleBase
    {
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "hello", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "say", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "test", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "info", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "whoami", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "starcraft", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "cat", Context.User.Username));
            ...
            {
                string url = "http://random.cat/meow";
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "help", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "leave", Context.User.Username));
        ...
        {
            Console.WriteLine(string.Format("{0} Executing Command: {1} by {2}", DateTime.Now.ToString("hh:mm:ss"), "pun", Context.User.Username));
